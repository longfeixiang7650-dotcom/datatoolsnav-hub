...
export const metadata: Metadata = {
  ...
  description:
    "Data Tools Nav is an independent directory of data analytics and business intelligence tools. We curate and compare BI platforms to help businesses make informed decisions.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#8BA3BE] leading-relaxed max-w-2xl mx-auto">
            Data Tools Nav is an independent directory that helps businesses
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 text-[#8BA3BE] leading-relaxed">
            <p>
              Data Tools Nav was created to solve a common problem: finding
            ...
            <p>
              We catalog and compare data and analytics tools across 15+ categories,
        ...
        <div className="text-center bg-[#0F1D32] border border-[#1E3A5F] rounded-xl p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:info@datatoolsnav.net"
