...
const FEATURED_TOOLS: Tool[] = [
  {
    ...
    rating: 4.7,
    reviews: 4820,
    description: 'Industry-leading data visualization platform for interactive dashboards and analytics.',
    icon: BarChart3,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 3150,
    description: 'Cloud-native data platform for storage, processing, and real-time analytics.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    rating: 4.4,
    reviews: 1250,
    description: 'Enterprise BI platform with embedded analytics and semantic modeling layer.',
    icon: MessageSquare,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 890,
    description: 'Transform data in your warehouse using SQL-based analytics engineering workflows.',
    icon: Users,
    pricing: 'Free / From $100/mo',
  },
  {
    id: 'tool-5',
    name: 'Fivetran',
    ...
    rating: 4.5,
    reviews: 1650,
    description: 'Automated data pipeline platform connecting 500+ SaaS sources to your warehouse.',
    icon: CreditCard,
    pricing: 'From $200/mo',
  },
  {
