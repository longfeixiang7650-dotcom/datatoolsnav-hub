...
export const ALL_TOOLS: ToolData[] = [
    ...
    longDescription: "Tableau (v2026.1) remains the market-leading visual analytics platform, empowering 92,000+ organizations—including 87% of Fortune 500 companies—with scalable, governed self-service analytics. Core capabilities include natural-language query (Ask Data v3), Explain Data AI-powered diagnostics, real-time data blending across 200+ connectors (including Snowflake Native, Databricks Unity Catalog, and SAP HANA), and pixel-perfect dashboarding with mobile-optimized responsive design. The Tableau Cloud ecosystem offers robust extensibility via REST API v4, Python/R integration (TabPy & Rserve deprecated in favor of native Scripting API), Tableau Exchange with 1,200+ certified extensions, and seamless integration with Salesforce Data Cloud and Microsoft Fabric. Governance is enterprise-ready: granular row-level security (RLS), automated metadata tagging via Tableau Catalog (powered by Apache Atlas + NLP), centralized usage analytics, and SOC 2 Type II, HIPAA, and GDPR-compliant admin controls including SSO/SAML 2.0, SCIM provisioning, and audit logging retention up to 365 days.",
    ...
    pricingDetail: "Tableau Cloud pricing starts at $75/user/month (Creator), $42/user/month (Explorer), and $15/user/month (Viewer); annual contracts required; custom enterprise agreements include premium support and dedicated success managers.",
