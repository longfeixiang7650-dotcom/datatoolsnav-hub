...
`,
  ...
  },
  {
    ...
    pros: ["Robust, version-controlled semantic layer (LookML) ensures metric consistency across teams", "Deep native integration with Google Cloud (BigQuery, Vertex AI, Cloud Storage)", "Enterprise-grade governance: row-level security, audit logging, and SOC 2/HIPAA/FedRAMP compliance", "Powerful embedded analytics SDK with white-labeling and usage-based licensing", "Real-time NLQ powered by Gemini Pro with high intent accuracy"],
    cons: ["Steeper learning curve for non-SQL analysts due to LookML dependency", "Limited offline capabilities — requires persistent internet connectivity", "Higher TCO for hybrid/multi-cloud deployments outside Google Cloud", "Fewer out-of-the-box visualization options compared to Tableau"],
    pricing: "From $30/user/mo",
    pricingDetail: "Looker offers three tiers: Explore ($30/user/mo) includes core BI, basic embedding, and 10K monthly queries; Advanced ($65/user/mo) adds NLQ, advanced RLS, custom visualizations, and priority support; Enterprise ($95/user/mo) includes unlimited queries, full embedding SDK, dedicated customer success, SLA-backed uptime (99.95%), and private cloud deployment options. Minimum commitment: 10 users. Volume discounts available for 100+ users. Embedded analytics licensed separately at $0.02 per active daily user (ADU) or $150/month minimum.",
    features: ["LookML semantic modeling layer", "Natural language query (NLQ) with Gemini Pro", "Embedded analytics SDK with white-labeling", "Row-level security and attribute-based access control", "Git-integrated development workflow", "Real-time dashboard refresh (<15s)", "Federated querying across BigQuery, Snowflake, Redshift, Databricks", "Automated anomaly detection with ML-powered insights"],
