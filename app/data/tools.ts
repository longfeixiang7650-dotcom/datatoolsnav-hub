...
`,
  ...
  },
  {
    ...
    pros: [
      ...
      "Robust embedded analytics SDK supports white-labeling and custom app integration",
      "Granular row-level security ensures precise data access control per user or group",
      "Deep native integration with Google Cloud services (BigQuery, Vertex AI, Cloud Storage)",
      "Git-integrated development workflow enables CI/CD, code reviews, and branch-based testing",
      "Real-time dashboards with live data refresh and interactive exploration",
      "Enterprise-grade compliance certifications including SOC 2, HIPAA, and FedRAMP"
    ],
    cons: [
      "Steeper learning curve for non-technical users adopting LookML modeling",
      "LookML expertise required for advanced customization and optimization",
      "Limited offline capabilities\u2014requires persistent cloud connectivity",
      "Cost can scale significantly with high concurrent usage and premium features"
    ],
    pricing: "Usage-based with tiered plans; starts at $10/user/month for Core, $30/user/month for Advanced, plus compute costs for BigQuery and Vertex AI.",
    pricingDetail: "Core plan includes basic dashboards, LookML modeling, and standard connectors. Advanced adds NLQ, embedded analytics, RLS, and federated querying. Enterprise adds SSO, audit logging, and dedicated support. BigQuery compute, Vertex AI inference, and storage incur separate Google Cloud charges. Annual billing offers ~15% discount; free trial available.",
    features: [
