...
export const metadata: Metadata = {
  title: "Terms of Service — NoCode Tool Hub",
  description:
    "Read the Terms of Service for NoCode Tool Hub. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
